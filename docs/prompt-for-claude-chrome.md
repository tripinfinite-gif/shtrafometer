...
- Продаём: PDF-отчёты (1990 ₽), автоисправление нарушений (4990-14990 ₽), мониторинг (490 ₽/мес), консалтинг (15000 ₽)
...
После получения ключей — сообщи мне shopId и secretKey, я добавлю их в Vercel.
